    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            window.onload = function(){
            	var oInput = document.getElementById("testValue");
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="addCost.do" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" value="" class="width100" name="unitCost" id="testValue"/>
                    <span class="info">元/小时</span>
                    <span class="required">*</span>
                    <div class="validate_msg_long error_msg" id="dis" style="display:none;">0-99999.99之间的数值</div>
                </div>
                ...
                <div class="button_info clearfix">
                    <input type="button" value="保存" class="btn_save"  onclick="javascript:document.forms[0].submit();" />
